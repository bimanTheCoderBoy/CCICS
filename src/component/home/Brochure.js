            ...
            <div className="row">
                ...
                <div className="col-8 col-ab-ccics">
                    ...
                    <h4 className="FM4">
                        ...
                        Many computational intelligence and learning methods, such as Machine Learning, neural networks,
                        genetic algorithms, IoT and so on, have found success in a variety of control and automation
                        fields. Intelligent Control, which differs from conventional approaches, is based on methodologies
                        derived from Artificial Intelligence and soft computing techniques and is capable of dealing with
                        problems in diverse computational and communication domains and, more recently, those related to
                        renewable energy and mobile autonomous systems, where conventional methods were unsuccessful.
                        Nevertheless, new technologies such as artificial intelligence, edge computing, and the Internet
                        of Things have led to an unprecedented development of control and communication. The conference is
                        devoted to intelligent systems that improve the control of nonlinear systems and its applications
                        ...
                        computing technologies, Software Engineering and other contemporary issues like High Performance
                        Computing, Distributed Computing and Grid Computing. The main aim of this International Conference
                        is to contribute to the academic arena, business world, and industrial community and in turn to
                        society.
                    </h4>
                </div>
            </div>
